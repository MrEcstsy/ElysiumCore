...
class HollowGuardian extends Living {
    ...
    {
        return "Hollow Guardian";
    }

    public function getNameTag(): string
    {
        return "§r§l§fHollow Guardian \n" . $this->getHealthBar();
    }
    ...
    public function onCollideWithBlock(): void {
    ...
    public function kill(): void {
        ...
        if ($closestPlayer instanceof Player) {
            ...
            $closestPlayer->sendMessage(TextFormat::WHITE . TextFormat::BOLD . "Hollow Guardian >> " . TextFormat::RESET . $randomMessage);
        }
    }
