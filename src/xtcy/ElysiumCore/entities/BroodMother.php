...
class BroodMother extends Living {
    ...
    public function kill(): void
    {
        ...
        $rewardIndex = 0;
        $topPlayersMessage = "&r&8----------[ &5&lBrood Mother &r&8]----------\n";
        foreach ($this->damageTracker as $playerName => $damage) {
            ...
            if ($player = Server::getInstance()->getPlayerExact($playerName)) {
                ...
                $player->sendMessage(Textformat::colorize("&r&l&f(!) &r&fYou dealt &b" . round($damagePercentage, 2) . "%&r&f damage to the &5Brood Mother&r!"));
