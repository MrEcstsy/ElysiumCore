...
class SoulCrystal extends Living {
    ...
    public function entityBaseTick(int $tickDiff = 1): bool {
        ...
        if ($this->tickCounter >= 200) {
            ...
            $guardian = new SoulGuardian($this->getLocation());
            $guardian->spawnToAll();
        }
    ...
    public function kill(): void
    {
        ...
        foreach ($this->damageTracker as $playerName => $damage) {
            ...
            if ($player = Server::getInstance()->getPlayerExact($playerName)) {
                ...
                $reward = ElysiumUtils::getRewardForPlace($rewardIndex, "soul");
        ...
        $messages = [
            "               &r&f&l<&r&fIncursion&f: &4Soul&r&f&l>",
            "&r&7&o The Soul Guardians' relentless assault has finally ceased.",
            "&r&7&o  The balance of the spiritual realm is restored.",
            "&r&7&o   The rift they emerged from closes, bringing peace back to the land.",
        ];
