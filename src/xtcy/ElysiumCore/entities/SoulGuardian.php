...
class SoulGuardian extends Living {

    public const NETWORK_ID = EntityIds::WITHER_SKELETON;
    /** @var float $width */
    ...
    public array $messages = [
        "The Soul Guardians will reject you forever!",
        "You cannot escape the wrath of the gods!",
        "Feel the despair of the all powerful!",
        "Your soul is now a part of us!",
    ...
    {
        return "Soul Guardian";
    }

    public function getNameTag(): string
    {
        return "§r§l§4Soul Guardian \n" . $this->getHealthBar();
    }
    ...
    public function kill(): void {
        ...
        if ($closestPlayer instanceof Player) {
            ...
            $closestPlayer->sendMessage(TextFormat::RED . TextFormat::BOLD . "Soul Guardian >> " . TextFormat::RESET . $randomMessage);
        }
    }
